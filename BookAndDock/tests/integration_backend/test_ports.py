...
class DockAdminIntegrationTests(TestCase):
    @classmethod
    ...
    def test_view_docks_renders_even_if_empty(self):
        url = reverse("docks")
        response = self.client.get(url)

        # If backend is up, this should not be a 500 due to connection failure
